...
function ecvetstep_footer_content() { 
	...
	if ( ( !$ecvetstep_footer_content = get_transient( 'ecvetstep_footer_content' ) ) ) {
		...
		global $ecvetstep_options_settings;
      	...
      	$ecvetstep_footer_content = '<div class="copyright"><a href="/copyright.html">Copyright &copy; 2014-2015 ECVET-STEP. Some Rights Reserved.</a><br/><br/>The ECVET-STEP project is supported by the European Commission under the Lifelong Learning Programme (LLP). This website is the sole responsiblity of ECVET-STEP Consortium and does not represent the opinion of the European Commission nor is the European Commission responsible for any use that might be made of the information appearing herein.</div><div class="powered"><img src="'. get_template_directory_uri() . '/images/EU_flag_LLP_EN-small.png"/></div>';
